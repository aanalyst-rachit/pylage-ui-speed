...
def get_app():
    return Column(
        ps.Heading("PyLage UI Kit — Stat Group", level=2),
        ps.Text("Responsive KPI grid patterns for executives and analytics dashboards."),
        ui.stat_group(
        ...
        ps.Heading("Quick Mapping Definition", level=3),
        ui.stat_group(
            items=[
